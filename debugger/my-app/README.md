...
1. 下载： `git clone https://github.com/facebook/react`
2. reset commit React v18.2.0 版本源码：`git reset --hard 80f3d88190c07c2da11b5cac58a44c3b90fbc296`
3. 修改 debugger/react/scripts/rollup/build.js 配置，修改 node 版本 v14.17.6，使用 yarn 安装依赖
  ...
  return {
    ...
    sourcemapPathTransform(relativeSourcePath, sourcemapPath) {
      return relativeSourcePath.replace(
        '../../../../packages',
        '/Users/meizu/Desktop/react/debugger/react/packages'
      )
    }
  }
}
...
4. yarn build 打包 React 源码
5. 复制 build 的 react 和 react-dom 替换项目里 node_modules 对应的
